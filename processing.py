...
def ProcessAndGenerateFlow(descriptors: list) -> Digraph:
    ...
    index = 0
    prev_id = None
    current_interface_subclass = 0  # Initialize to avoid undefined variable
    while index < len(descriptors):
        ...
        if bDescriptorType == 1:  # Device Descriptor
            ...
            current_interface_subclass = descriptor[6]  # bInterfaceSubClass
        ...
        elif bDescriptorType == 6:  # Device Qualifier Descriptor
            table_str = CreateDeviceQualifierDescriptorNode(descriptor)
        elif bDescriptorType == 7:  # Other Speed Configuration Descriptor
